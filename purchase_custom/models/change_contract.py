...
class ChangeContract(models.Model):
    ...
    vendor_id = fields.Many2one(comodel_name='res.partner', string='Contracer', tracking=True)
    ...
    reason_for_change = fields.Binary(string='Reason for change',tracking=True)
    ...
    state = fields.Selection(string="Status", selection=[('user_department', 'User Department'), 
                                                         ...
                                                         ('changed', 'Changed'),
                                                         ('reject', 'Rejected'),], default='user_department', tracking=True)
    ...
    buyer = fields.Many2one(comodel_name='res.users', string='Assign buyer', tracking=True)
