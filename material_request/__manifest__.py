# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'mail','maintenance','base_rida','account', 'purchase', 'mrp',  'purchase_stock','stock_last_purchase_price','purchase_requisition','stock', 'purchase_discount','mrp_landed_costs','stock_landed_costs_currency','sale', 'mrp'],
