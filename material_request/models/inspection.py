...
class MaterialInspectionLine(models.Model):
    ...
    qty_on_bill = fields.Float(string='Qty. on bill', tracking=True, )
    qty_received = fields.Float(string='Qty Received', tracking=True, )
    qty_accepted = fields.Float(string='Qty Accepted', tracking=True, )
    qty_rejected = fields.Float(string='Qty Rejected', tracking=True, )
    qhse_qty_accepted = fields.Float(string='QHSE Qty Accepted', tracking=True, )
    qhse_qty_rejected = fields.Float(string='QHSE Qty Rejected', tracking=True, )
