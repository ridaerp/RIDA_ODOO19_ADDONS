...
class DeviceRequest(models.Model):
    ...
    def create(self, vals):
        vals['name'] = self.env['ir.sequence'].get('device.request.code') or ' '
        res = super(DeviceRequest, self).create(vals)
        return res
...
class RealocationDeviceRequest(models.Model):
    ...
    @api.model
    def create(self, vals):
        vals['name'] = self.env['ir.sequence'].get('realocation.device.request') or ' '
        res = super(RealocationDeviceRequest, self).create(vals)
        return res
