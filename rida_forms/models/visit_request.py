...
class VisitRequest(models.Model):
    ...
    requested_by = fields.Many2one("res.users", readonly=True, string="Requested Employee", tracking=True,
    ...
    def create(self, vals):
        for val in vals:
            if val.get('name_seq', 'New') == 'New':
                val['name_seq'] = self.env['ir.sequence'].next_by_code('visit.request') or 'New'
