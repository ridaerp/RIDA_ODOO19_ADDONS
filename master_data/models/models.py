...
class EditProduct(models.Model):
    ...
    def create(self, vals):
        vals['name'] = self.env['ir.sequence'].get('edit.product') or ' '
        res = super(EditProduct, self).create(vals)
        return res
...
class RequestProduct(models.Model):
    ...
    @api.model
    def create(self, vals):
        vals['name'] = self.env['ir.sequence'].get('item.request') or ' '
        res = super(RequestProduct, self).create(vals)
        return res
