...
import odoo.addons.hr_expense.models.hr_expense_sheet as expense_sheet_custom
...
class ExpensesWorkflow(models.Model):
    ...
    def _check_can_create_move(self):
        pass
        # super(ExpensesWorkflow, self)._check_can_create_move()
        ...
        #
        # # if any(sheet.state not in  ['submit' ,'ccso','site','accountant'] for sheet in self):
    ...
    # def action_approve_expense_sheets(self):
    #     result = super(ExpensesWorkflow, self).action_approve_expense_sheets()
...
# lm manager buttons
    def action_approve_sheets(self):
        ...
        try:
            ...
            # elif self.employee_id.user_id.line_manager_id:
...
# ccso buttons
    ...
    #         return
    #
    #     if any(sheet.state != 'accountant' for sheet in self):
...
class ExpensesCustom(models.Model):
    ...
    # analytic_account_id=fields.Many2one(related="employee_id.department_id.analytic_account_id",readonly=False)
    @api.model
